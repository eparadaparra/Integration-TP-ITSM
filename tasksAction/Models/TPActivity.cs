namespace tasksAction.Models
{
    ...
    {
        public string? status { get; set; }
        public string? scheduled_user_email { get; set; }    // Por Recibir
        ...
        public List<Tareas>? elements { get; set; }
    ...
    public partial class Items
    {
        ...
        public string? type { get; set; }
        //public string? value { get; set; }  //Validar como recivir Bool y String
